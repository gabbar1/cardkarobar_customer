...
class _MyWorkState extends State<MyWork> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              actions: [
                widget.status == "new_number"
                    ? Obx(() => CircleAvatar(
                          ...
                          child: Text(
                              _myWorkController.getContacts.length.toString()),
                        ))
                    : Obx(() => CircleAvatar(
                          backgroundColor:
                              Constants().mainColor.withOpacity(0.5),
                          child: Text(_myWorkController
                              .getHistoryLeadList.length
                              .toString()),
                        )),
                SizedBox(
                  width: 20,
      ...
      body: widget.status == "new_number"
          ? Obx(() => _myWorkController.getContacts.isEmpty
              ? Center(
                          ...
                          child: InkWell(
                            onTap: () {
                              Get.to(StatusUpdate(
                                index: index,
                                isNewEntry: false,
                                userContactModel: _myWorkController.getContacts[index],
