...
import 'package:upen/screen/sell_earn/refer_product_view.dart';

import '../assigned_lead/assign_lead_view.dart';
        ...
        child: Column(
          ...
          children: [
                ...
                items: dashBoardController.getBanners.map((bannerIndex) {
                  return Builder(
                    builder: (BuildContext context) {
                      return CachedNetworkImage(fit: BoxFit.fill,imageUrl: bannerIndex.image,
            ...
            _personalDetailsController.getIsAdmin !=
                null &&
                _personalDetailsController.getIsAdmin ? Padding(
                  ...
                  child: CircleAvatar(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 5,),
                        CommonText(text: "Assign to ", fontStyle: FontWeight
                            .bold, textColor: Colors.white)
                      ],
                    ),
                  ),
                      ...
                      Row(
                        ...
                        children: [
                         ...
                         // Image.network(_PartnerController.getProductCategoryDashBoardList[index].categoryUrl),
                          CachedNetworkImage(imageUrl: _PartnerController.getProductCategoryDashBoardList[index].categoryUrl)
